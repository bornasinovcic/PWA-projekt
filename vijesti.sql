...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=2401207087ltr&server=1">
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/printview.css?v=5.1.3" media="print" id="printcss">
    <title>127.0.0.1 / 127.0.0.1:3306 | phpMyAdmin 5.1.3</title>
...
<body>
    <div id="pma_navigation" data-config-navigation-width="297">
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=projekt&table=vijesti">`projekt`.`vijesti`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=test&table=osoba">`test`.`osoba`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=test&table=kolegiji">`test`.`kolegiji`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=test&table=clanak">`test`.`clanak`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=projekt&table=clanak">`projekt`.`clanak`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=test&table=users">`test`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=test&table=korisnik">`test`.`korisnik`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=studij&table=zaposlenik">`studij`.`zaposlenik`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=studij&table=student">`studij`.`student`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=studij&table=predmet">`studij`.`predmet`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="2227787c4854212d6e5b607e367e582e">
...
</span><small>Set to 0 to collapse navigation panel.</small></th><td><input type="number" name="NavigationWidth" id="NavigationWidth" class="custom" value="297"><a class="restore-default hide" href="#NavigationWidth" title="Restore default value"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_reload"></a></td></tr></table>
</fieldset>
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="projekt" targettable="vijesti">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `vijesti`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="projekt" targettable="vijesti">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO vijesti (datum, naslov, sazetak, tekst, slika, kategorija, arhiva) VALUES (&#039;2022-06-14&#039;, &#039;w&#039;, &#039;w&#039;, &#039;w&#039;, &#039;eurovision_boycott.jpg&#039;, &#039;World&#039;, 1);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="projekt" targettable="vijesti">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO vijesti (datum, naslov, sazetak, tekst, slika, kategorija, arhiva)
VALUES
(&#039;2022-06-14&#039;, &#039;s&#039;, &#039;s&#039;, &#039;s&#039;, &#039;iran_navy.jpg&#039;, &#039;World&#039;, 1),
(&#039;2022-06-14&#039;, &#039;x&#039;, &#039;x&#039;, &#039;x&#039;, &#039;ukraine_tank.jpg&#039;, &#039;World&#039;, 1);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="projekt" targettable="vijesti">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">DELETE FROM `vijesti` WHERE `vijesti`.`id` = 13</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="projekt" targettable="vijesti">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">UPDATE vijesti
SET arhiva = 1
where id = 1;</span>
                        </div>
                                            <div class="message history collapsed hide"
...
where id IN(1, 2, 3, 4, 5, 6);</span>
            ...
            Queried time
                            ...
                            <span class="query">UPDATE vijesti
SET arhiva = 0
where id IN(7, 8, 9, 10, 11, 12);</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="projekt" targettable="vijesti">
                            <div class="action_content">
